                                ...
                                <div className="timeline-item mt-4">
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <div className="duration date-label-left border rounded p-2 pl-4 pr-4 position-relative shadow text-left">2015 - 2018</div>
                                        </div>
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div className="timeline-item mt-4">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-6 order-sm-2 order-1">
                                            <div className="duration duration-right rounded border p-2 pl-4 pr-4 position-relative shadow text-left">2012 - 2015</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="timeline-item mt-4">
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <div className="duration date-label-left border rounded p-2 pl-4 pr-4 position-relative shadow text-left">2010 - 2012</div>
                                        </div>
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <div className="event event-description-right rounded p-4 border float-left text-left">
